...
<body class="respond" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
    ...
    <table style="display:none!important;">
        <tr>
            <td>
                <div style="overflow:hidden;display:none;font-size:1px;color:#ffffff;line-height:1px;font-family:Arial;maxheight:0px;max-width:0px;opacity:0;"> Welcome to {{ Config::get('app.name') }}
                 {{ $data['fname'] }}. Your account is ready. Login with the following credentials.
                 <br>
                 Username: <b>{{ $data['email'] }}</b> <br>
                 Default password: <b>{{ $data['dpass'] }}</b><br>
                </div>
            </td>
        </tr>
    </table>
                    ...
                    <tr>
                        <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                            ...
                            <div style="line-height: 24px">
                                ...
                                <br>
                                Username: <b>{{ $data['email'] }}</b> <br>
                                Default password: <b>{{ $data['dpass'] }}</b>
                                <br><br>
