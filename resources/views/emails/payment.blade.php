        ...
        <tr>
            <td>
                <div style="overflow:hidden;display:none;font-size:1px;color:#ffffff;line-height:1px;font-family:Arial;maxheight:0px;max-width:0px;opacity:0;"> 
                 Your {{ Config::get('app.name') }} subscription payment was successful<br>
                </div>
            </td>
        </tr>
    </table>
                ...
                <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                    <tr>
                        <td align="center" style="color: #343434; font-size: 34px; font-family: Quicksand, Calibri, sans-serif; font-weight:900;letter-spacing: 3px; line-height: 35px;" class="main-header">
                            ...
                            <span style="color: #036a6b;">Payment to {{ Config::get('app.name') }}</span>
                            </div>
                            <br>
                        </td>
                    </tr>
                    <tr>
                        <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                            ...
                            Your {{ Config::get('app.name') }} subscription payment of 
                            <b>${{ $data['amount'] }}</b>
                            was successful<br>
                                <br><br>
