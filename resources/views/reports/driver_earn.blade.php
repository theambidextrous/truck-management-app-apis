...
<!-- <div class="container-fluid invoice-container">  -->
    ...
    <table class="table" id="customers" width="800px">
      <tr class="td-borderless" style="background-color: #ffffff !important;">
        ...
        <td class="td-borderless" style="text-align:right!important;width:350px">
            <span style="font-weight:700; font-size:20px">Driver Pay</span><br>
            ...
            <span style="font-weight:700; font-size:20px">License #{{ $owner->license }}</span><br>
        </td>
      </tr>
      </table>      
    </div>
  ...
  <!-- Main Content -->
    <!-- TRIPS ================== -->
    <h4 class="text-4 mt-2"><b>Driver Trips:</b></h4>
   <table class="table" id="customers" width="800px">
